...
@Composable
fun LearnTogetherText1(modifier: Modifier = Modifier) {
...
@Composable
fun LearnTogetherText2(modifier: Modifier = Modifier) {
    Text(
...
@Composable
fun LearnTogetherText3(modifier: Modifier = Modifier) {
    ...
    Text(
        text = "In this tutorial, you build a simple UI component with declarative functions. " +
                ...
                " rather than focus on the process of the UI construction, such as initializing an element and then attaching it to a parent. To create a " +
